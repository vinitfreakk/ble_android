...
import com.accidentaldeveloper.ble.data.ConnectionState
...
class TemperatureAndHumidityBLEReceiveManager @Inject constructor(
    ...
    //this parameters will be different for different devices
    private val DEVICE_NAME = "VINIT_BLE"
            ...
            with(characteristic){
                when(uuid){
                    UUID.fromString(TEMP_HUMIDITY_CHARACTERISTICS_UUID) -> {
                        //XX XX XX XX XX XX   this parsing can be different for different devices.
    ...
    private fun enableNotification(characteristic: BluetoothGattCharacteristic){
        val cccdUuid = UUID.fromString(CCCD_DESCRIPTOR_UUID) // this coming from BleExtension file this can be different for different devices
         val payload = when {
